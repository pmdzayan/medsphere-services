export const permissionsEnglishMessages = {
  ...
  'permissions.location.explanation':
    '{brandFullName} uses your current location only to find nearby healthcare providers and medicine availability.',
  'permissions.location.precision':
    'If you continue, your browser may share precise location for this search. {brandFullName} does not continuously track or store it in your browser.',
...
export const permissionsTamilMessages: Record<PermissionsTranslationKey, string> = {
  ...
  'permissions.location.explanation':
    'அருகிலுள்ள சுகாதார சேவை வழங்குநர்களையும் மருந்து கிடைப்பையும் கண்டறிய மட்டுமே {brandFullName} உங்கள் தற்போதைய இருப்பிடத்தைப் பயன்படுத்துகிறது.',
  'permissions.location.precision':
    'நீங்கள் தொடர்ந்தால், இந்தத் தேடலுக்காக உங்கள் உலாவி துல்லியமான இருப்பிடத்தைப் பகிரலாம். {brandFullName} அதைத் தொடர்ந்து கண்காணிக்கவோ உங்கள் உலாவியில் சேமிக்கவோ செய்யாது.',
...
export const permissionsUrduMessages: Record<PermissionsTranslationKey, string> = {
  ...
  'permissions.location.explanation':
    '{brandFullName} آپ کا موجودہ مقام صرف قریبی صحت فراہم کنندگان اور دوا کی دستیابی تلاش کرنے کے لیے استعمال کرتا ہے۔',
  'permissions.location.precision':
    'اگر آپ جاری رکھیں تو آپ کا براؤزر اس تلاش کے لیے درست مقام شیئر کر سکتا ہے۔ {brandFullName} مسلسل نگرانی نہیں کرتا اور اسے آپ کے براؤزر میں محفوظ نہیں کرتا۔',
