...
const safeguards = [
  ['01', 'Policy controlled', 'The organization must explicitly permit self-registration.'],
  ['02', 'Pending by default', 'A request does not create an active tenant membership.'],
  ['03', 'Privacy preserving', 'The response never reveals existing accounts or organizations.'],
] as const;
        ...
        <aside className="fine-noise premium-grid relative hidden overflow-hidden bg-[#071713] p-10 text-white lg:flex lg:flex-col lg:justify-between xl:p-14">
          ...
          <div className="relative max-w-xl">
            <div className="mb-7 inline-flex items-center gap-3 rounded-full border border-[#d7b56d]/25 bg-[#d7b56d]/[.07] px-4 py-2 text-[10px] font-bold uppercase tracking-[.2em] text-[#e8cc91]">
              <span className="h-px w-5 bg-[#d7b56d]" /> Trusted onboarding
            </div>
            <h1 className="font-[var(--font-display)] text-5xl font-semibold leading-[1.02] tracking-[-.055em] xl:text-6xl">
              Access begins with
              <span className="block text-emerald-300">verified context.</span>
            </h1>
            <p className="mt-6 max-w-lg text-base leading-8 text-white/48">
              Request a pending membership for an organization that has explicitly enabled public
              onboarding. Approval and activation remain under organization policy.
            </p>
          ...
          <div className="w-full max-w-[36rem] pt-20 lg:pt-0">
            <div className="mb-8">
              ...
              <p className="mt-4 max-w-lg text-sm leading-7 text-[#60706b]">
                This form submits a pending request. It does not guarantee account creation,
                organization membership, or immediate access.
              </p>
            </div>
            <RegistrationForm />
            <div className="mt-7 flex items-start gap-3 border-t border-[#10201c]/[.08] pt-5 text-xs leading-5 text-[#71807b]">
              ...
              Use test identities only. This stabilization environment is not approved for real
              patient, employee, or clinical data.
            </div>
          </div>
        </section>
      </div>
